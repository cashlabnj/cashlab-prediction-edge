...
4/ The bias, measured in real data: across 306,598 actually-settled Kalshi markets (2026-05-19 → 2026-09-13), the NO side settles at 76.3% overall. In the 0–10¢ price bucket? 99.39% NO.

5/ That's the favorite-longshot bias, empirically confirmed in 306,598 real outcomes — not a theory, not a backtest. The longshot (YES) side is systematically overpriced.
